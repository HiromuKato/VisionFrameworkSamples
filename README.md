...
| 処理内容 | リクエスト | 出力オブジェクト | サンプル番号 |
| ---- | ---- | ----- | ----- |
| 画像識別 | [VNClassifyImageRequest](https://developer.apple.com/documentation/vision/vnclassifyimagerequest) | [[VNClassificationObservation]](https://developer.apple.com/documentation/vision/vnclassificationobservation) | [3](https://developer.apple.com/documentation/vision/classifying_images_for_categorization_and_search) |
| 画像の顕著性認識 | [VNGenerateAttentionBasedSaliencyImageRequest](https://developer.apple.com/documentation/vision/vngenerateattentionbasedsaliencyimagerequest)<br>[VNGenerateObjectnessBasedSaliencyImageRequest](https://developer.apple.com/documentation/vision/vngenerateobjectnessbasedsaliencyimagerequest) | [[VNSaliencyImageObservation]](https://developer.apple.com/documentation/vision/vnsaliencyimageobservation) | [6](https://developer.apple.com/documentation/vision/highlighting_areas_of_interest_in_an_image_using_saliency) |
| 画像の位置合わせ | [VNTranslationalImageRegistrationRequest](https://developer.apple.com/documentation/vision/vntranslationalimageregistrationrequest)<br>[VNHomographicImageRegistrationRequest](https://developer.apple.com/documentation/vision/vnhomographicimageregistrationrequest) | [[VNImageTranslationAlignmentObservation]](https://developer.apple.com/documentation/vision/vnimagetranslationalignmentobservation)<br>[[VNImageHomographicAlignmentObservation]](https://developer.apple.com/documentation/vision/vnimagehomographicalignmentobservation) | [15](https://developer.apple.com/documentation/vision/aligning_similar_images), [19](https://developer.apple.com/documentation/vision/training_a_create_ml_model_to_classify_flowers)|
| 画像の類似性判定 | [VNGenerateImageFeaturePrintRequest](https://developer.apple.com/documentation/vision/vngenerateimagefeatureprintrequest) | [[VNFeaturePrintObservation]](https://developer.apple.com/documentation/vision/vnfeatureprintobservation) | [4](https://developer.apple.com/documentation/vision/analyzing_image_similarity_with_feature_print) |
| オブジェクトの検出 | (複数のリクエスト) | (複数のオブジェクト) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images) |
| オブジェクトのトラッキング | (複数のリクエスト) | (複数のオブジェクト) | [8](https://developer.apple.com/documentation/vision/tracking_multiple_objects_or_rectangles_in_video) |
| 軌道検出 | [VNDetectTrajectoriesRequest](https://developer.apple.com/documentation/vision/vndetecttrajectoriesrequest) | [[VNTrajectoryObservation]](https://developer.apple.com/documentation/vision/vntrajectoryobservation) | [11](https://developer.apple.com/documentation/vision/detecting_moving_objects_in_a_video) |
...
| テキスト検出 | [VNDetectTextRectanglesRequest](https://developer.apple.com/documentation/vision/vndetecttextrectanglesrequest) | [[VNTextObservation]](https://developer.apple.com/documentation/vision/vntextobservation) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images)|
| テキスト認識 | [VNRecognizeTextRequest](https://developer.apple.com/documentation/vision/vnrecognizetextrequest) | [[VNRecognizedTextObservation]](https://developer.apple.com/documentation/vision/vnrecognizedtextobservation) | [12](https://developer.apple.com/documentation/vision/structuring_recognized_text_on_a_document), [13](https://developer.apple.com/documentation/vision/reading_phone_numbers_in_real_time), [14](https://developer.apple.com/documentation/vision/locating_and_displaying_recognized_text)|
| 顔検出 | [VNDetectFaceRectanglesRequest](https://developer.apple.com/documentation/vision/vndetectfacerectanglesrequest) | [[VNFaceObservation]](https://developer.apple.com/documentation/vision/vnfaceobservation) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images), [5](https://developer.apple.com/documentation/vision/applying_matte_effects_to_people_in_images_and_video), [7](https://developer.apple.com/documentation/vision/tracking_the_user_s_face_in_real_time) |
| フェイストラッキング | (複数のリクエスト) | (複数のオブジェクト) | [7](https://developer.apple.com/documentation/vision/tracking_the_user_s_face_in_real_time)|
| 顔のランドマーク | [VNDetectFaceLandmarksRequest](https://developer.apple.com/documentation/vision/vndetectfacelandmarksrequest) | [[VNFaceObservation]](https://developer.apple.com/documentation/vision/vnfaceobservation) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images), [7](https://developer.apple.com/documentation/vision/tracking_the_user_s_face_in_real_time)|
| 顔のキャプチャクオリティ | [VNDetectFaceCaptureQualityRequest](https://developer.apple.com/documentation/vision/vndetectfacecapturequalityrequest) | [[VNFaceObservation]](https://developer.apple.com/documentation/vision/vnfaceobservation) | [9](https://developer.apple.com/documentation/vision/selecting_a_selfie_based_on_capture_quality) |
...
| 手の形 | [VNDetectHumanHandPoseRequest](https://developer.apple.com/documentation/vision/vndetecthumanhandposerequest)| [[VNHumanHandPoseObservation]](https://developer.apple.com/documentation/vision/vnhumanhandposeobservation) | [10](https://developer.apple.com/documentation/vision/detecting_hand_poses_with_vision) |
...
| バーコード検出 | [VNDetectBarcodesRequest](https://developer.apple.com/documentation/vision/vndetectbarcodesrequest) | [[VNBarcodeObservation]](https://developer.apple.com/documentation/vision/vnbarcodeobservation) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images), [19](https://developer.apple.com/documentation/vision/training_a_create_ml_model_to_classify_flowers) |
| 矩形検出 | [VNDetectRectanglesRequest](https://developer.apple.com/documentation/vision/vndetectrectanglesrequest) | [[VNRectangleObservation]](https://developer.apple.com/documentation/vision/vnrectangleobservation) | [2](https://developer.apple.com/documentation/vision/detecting_objects_in_still_images), [8](https://developer.apple.com/documentation/vision/tracking_multiple_objects_or_rectangles_in_video) |
...
| 人物セグメンテーション | [VNGeneratePersonSegmentationRequest](https://developer.apple.com/documentation/vision/vngeneratepersonsegmentationrequest) | [[VNPixelBufferObservation]](https://developer.apple.com/documentation/vision/vnpixelbufferobservation)  | [5](https://developer.apple.com/documentation/vision/applying_matte_effects_to_people_in_images_and_video) |
